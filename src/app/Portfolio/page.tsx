    ...
    <main className="min-h-screen w-full flex flex-col p-6 ">
      ...
      >
        <div className="flex flex-col-reverse justify-between sm:flex-row items-center w-full">
          ...
          <div className="lg:w-6/12 w-full flex flex-col text-center sm:text-left px-4 sm:px-0">
            ...
            {/* CTA Buttons */}
            <div className="flex mt-4 sm:mt-8 gap-6 justify-center sm:justify-start">
              <button
                onClick={() =>
                  document
                ...
                className="px-4 sm:px-8 py-3 text-white text-sm sm:text-lg font-semibold rounded-full bg-gradient-to-r from-[#6a11cb] to-[#2575fc] shadow-lg hover:opacity-90 transition"
              >
                Contact Me
              </button>
              <a href="/Resume-1.pdf" download="My_CV.pdf">
                <button className="px-4 sm:px-8 py-3 text-white text-sm sm:text-lg font-semibold rounded-full bg-gradient-to-r from-[#ff416c] to-[#ff4b2b] shadow-lg hover:opacity-90 transition">
                  Download CV
                </button>
              </a>
            </div>

            <div className=" mt-4 sm:mt-16 flex sm:justify-between max-sm:justify-center max-sm:text-xs  max-sm:gap-10 sm:flex-nowrap lg:w-3/4 text-base sm:text-lg">
              ...
              {DATA.education.map((education, id) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 sm:gap-4">
                    <div className="w-12 h-12 rounded-full flex items-center justify-center bg-slate-200 dark:bg-white">
                      <img
                  ...
                  {/* Date */}
                  {/* Date */}
                  <p className="absolute top-2 right-2 text-xs sm:text-sm tabular-nums text-muted-foreground">
      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            Constantly evolving, my skills span across technologies and tools
            that empower me to build, innovate, and solve complex challenges. I
            believe in continuous learning and adapting to stay ahead in the
        ...
        <div className="mt-28 justify-items-center">
          <div className="justify-items-center text-center">
            ...
            <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              ...
              build impactful solutions, constantly refining skills and pushing
              boundaries.
            </p>
          </div>
          <div className="grid mt-9 grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 items-stretch">
            {displayedProjects.map((project, index) => {
              return (
                <CardContainer key={index} className="w-full h-full inter-var">
